...
uint256 hashGenesisBlock("0x12078836102ab56c4e9a3fbb76d18d6ed4182bb4f144a1aae9fd19ec0bdda112");
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1461747605, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        // Genesis block
        const char* pszTimestamp = "Egypt Clamps Down on Protests Over Red Sea Islands";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 500 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("043fb215d705c881e7f7bcef98bcdb02317dc14d3d35eec0178b4634e2d5d7487c90f57a1b942fe2d36df2675ec7d213b2a684e3dd3a7a2674035687635a9bd918") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1461747605;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1849504;
        ...
        assert(block.hashMerkleRoot == uint256("0x74ecf189594bbf841f306a6804831495cb1452903c8324936e682a11aae16043"));
...
unsigned char pchMessageStart[4] = { 0x60, 0x2f, 0x48, 0x72 }; // robocoin: increase each by adding 2 to bitcoin's value.
