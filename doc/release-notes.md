0.8.7.5 changes
=============
- openssl-1.0.1k or older versions patched for CVE-2014-8275 broke compatibility with Bitcoin and robocoin.
  This update patches robocoin to maintain compatibility with CVE-2014-8275 patched openssl.
- If you are running v0.8.7.4 as distributed by robocoin.org you do not need to upgrade.
  The binaries distributed on robocoin.org contain their own copy of openssl so they are unaffected by this issue.
